...
انقل كل ملفات مجلد ps3dream-ios للمستودع:
- CMakeLists.txt
- build_ios.sh
- .gitignore
- .github/workflows/build.yml
- Ps3Dream/ (المجلد كامل - فيه الكود الأصلي)
- aps3e-extracted/ (مجلد الكود الأصلي)

ملاحظة: مجلد aps3e-extracted يكون كبير (~3000 ملف)، هذا طبيعي

## الخطوة 6: ارفع الكود

1. في GitHub Desktop اضغط "Commit to main"
2. اضغط "Push origin"
3. انتظر شوي (الرفع قد ياخذ دقايق)

## الخطوة 7: شغّل البناء

1. روح لموقع مستودعك على GitHub
2. اضغط عل تبويب "Actions"
3. اضغط "Build Ps3Dream iOS" > "Run workflow"
4. انتظر 30-60 دقيقة
...
- لازم iPhone/iPad بمعالج Apple Silicon (A12 أو أحدث)
- لازم تفعّل Developer Mode: الإعدادات > الخصوصية والأمان > وضع المطورين
- أول مرة تفتح التطبيق ممكن يطلب منك توثيقه من الإعدادات
